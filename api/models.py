...
class Cuotas(models.Model):
    ...
    codseg = models.CharField(max_length=10,blank=True,  null=True)
...
class DriEstudioPadron(models.Model):
    ...
    id_estudioc = models.ForeignKey('DriEstudio', db_column='id_estudioc',related_name='estudio_padron',on_delete=models.CASCADE)
...
class DriCuotaActividad(models.Model):
    id_cuota_actividad = models.IntegerField(primary_key=True)
    ...
    id_cuota = models.IntegerField(null=True)
    class Meta:
...
class DriBoleta_actividades(models.Model):
    id = models.AutoField(primary_key=True)
    id_boleta = models.ForeignKey('DriBoleta', db_column='id_boleta',related_name='boleta_actividad',on_delete=models.CASCADE, null=True)    
...
class WEB_Liquidacion_ctas(models.Model):# pragma: no cover
    id_liquidacion = models.ForeignKey('WEB_Liquidacion', db_column='id_liquidacion',related_name='webliq_cuotas',on_delete=models.CASCADE)
