...
from api.models import Configuracion,Cuotas,Tributo,UserProfile
...
def login(request):
    ...
    try:
        sitio = Configuracion.objects.all()[0]
...
def login2(request):
    ...
    return render(request,'index2.html', {'dirMuni':MUNI_DIR,'sitio':sitio,'tributos':tributos})
